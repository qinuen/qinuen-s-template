...
public class JavaMailUtil {
	 ...
	 *             cc:抄送 Bcc:密送 To:发送
	 */
	public static MimeMessage creatMimeMessage(Session session, String sendMail, String receiveMail, String html)
		...
		message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "新朋友", "UTF-8"));
		// 4、Subject:邮件主题
		message.setSubject("您正在注册QnMemory云酒吧", "UTF-8");
